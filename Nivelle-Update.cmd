...
if exist "%~dp0apply_update.ps1" (
    ...
    powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%~dp0scripts\apply_update.ps1" %*
)

if errorlevel 1 goto failed
echo.
echo Nivelle update completed successfully.
...
:failed
echo.
echo Nivelle update failed. Review the error above.
